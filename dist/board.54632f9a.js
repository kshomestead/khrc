...
// Import Material Web buttons
var _filledButtonJs = require("@material/web/button/filled-button.js");
var _outlinedButtonJs = require("@material/web/button/outlined-button.js"); // Include other variants if needed
...
document.addEventListener("click", (event)=>{
    ...
    if (button && button.hasAttribute("data-target")) {
        ...
        } else console.error("Error: 'data-target' attribute is missing or invalid.");
    }
});
...
parcelHelpers.export(exports, "MdFilledButton", ()=>MdFilledButton);
var _tslib = require("tslib");
var _decoratorsJs = require("lit/decorators.js");
var _filledButtonJs = require("./internal/filled-button.js");
var _filledStylesJs = require("./internal/filled-styles.js");
var _sharedElevationStylesJs = require("./internal/shared-elevation-styles.js");
var _sharedStylesJs = require("./internal/shared-styles.js");
let MdFilledButton = class MdFilledButton extends (0, _filledButtonJs.FilledButton) {
};
MdFilledButton.styles = [
    (0, _sharedStylesJs.styles),
    (0, _sharedElevationStylesJs.styles),
    (0, _filledStylesJs.styles)
];
MdFilledButton = (0, _tslib.__decorate)([
    (0, _decoratorsJs.customElement)('md-filled-button')
], MdFilledButton);

},{"tslib":"lRdW5","lit/decorators.js":"bCPKi","./internal/filled-button.js":"e1dWo","./internal/filled-styles.js":"eljQm","./internal/shared-elevation-styles.js":"45UzR","./internal/shared-styles.js":"ae1j2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lRdW5":[function(require,module,exports,__globalThis) {
/******************************************************************************
...
},{}],"bCPKi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./base.js":"d0R9Y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e1dWo":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ parcelHelpers.export(exports, "FilledButton", ()=>FilledButton);
var _elevationJs = require("../../elevation/elevation.js");
var _lit = require("lit");
var _buttonJs = require("./button.js");
class FilledButton extends (0, _buttonJs.Button) {
    renderElevationOrOutline() {
        return (0, _lit.html)`<md-elevation part="elevation"></md-elevation>`;
    }
}

},{"../../elevation/elevation.js":"ddtTG","lit":"4antt","./button.js":"jHB4r","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ddtTG":[function(require,module,exports,__globalThis) {
/**
 * @license
...
},{"tslib":"lRdW5","lit/decorators.js":"bCPKi","./internal/elevation.js":"gqtSD","./internal/elevation-styles.js":"bJ3Du","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gqtSD":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
},{"lit":"4antt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jHB4r":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
var _tslib = require("tslib");
var _mdFocusRingJs = require("../../focus/md-focus-ring.js");
var _rippleJs = require("../../ripple/ripple.js");
var _lit = require("lit");
var _decoratorsJs = require("lit/decorators.js");
var _delegateJs = require("../../internal/aria/delegate.js");
var _formSubmitterJs = require("../../internal/controller/form-submitter.js");
var _formLabelActivationJs = require("../../internal/events/form-label-activation.js");
var _elementInternalsJs = require("../../labs/behaviors/element-internals.js");
// Separate variable needed for closure.
const buttonBaseClass = (0, _delegateJs.mixinDelegatesAria)((0, _elementInternalsJs.mixinElementInternals)((0, _lit.LitElement)));
class Button extends buttonBaseClass {
     ...
     */ get form() {
        return this[0, _elementInternalsJs.internals].form;
    }
    constructor(){
        super();
        /**
         ...
         * form.
         */ this.value = '';
        if (!(0, _lit.isServer)) this.addEventListener('click', this.handleClick.bind(this));
    }
    focus() {
    ...
    renderButton() {
        ...
        return (0, _lit.html)`<button
      id="button"
      class="button"
      ?disabled=${this.disabled}
      aria-disabled=${this.softDisabled || (0, _lit.nothing)}
      aria-label="${ariaLabel || (0, _lit.nothing)}"
      aria-haspopup="${ariaHasPopup || (0, _lit.nothing)}"
      aria-expanded="${ariaExpanded || (0, _lit.nothing)}">
      ${this.renderContent()}
    </button>`;
    }
    renderLink() {
      ...
      aria-expanded="${ariaExpanded || (0, _lit.nothing)}"
      href=${this.href}
      target=${this.target || (0, _lit.nothing)}
      >${this.renderContent()}
    </a>`;
    }
    renderContent() {
        const icon = (0, _lit.html)`<slot
      name="icon"
      @slotchange="${this.handleSlotChange}"></slot>`;
        return (0, _lit.html)`
      <span class="touch"></span>
      ${this.trailingIcon ? (0, _lit.nothing) : icon}
      <span class="label"><slot></slot></span>
      ${this.trailingIcon ? icon : (0, _lit.nothing)}
    `;
    }
    handleClick(event) {
        ...
        if (!(0, _formLabelActivationJs.isActivationClick)(event) || !this.buttonElement) return;
        this.focus();
        (0, _formLabelActivationJs.dispatchActivationClick)(this.buttonElement);
    }
    handleSlotChange() {
...
(()=>{
    (0, _formSubmitterJs.setupFormSubmitter)(Button);
})();
/** @nocollapse */ Button.formAssociated = true;
/** @nocollapse */ Button.shadowRootOptions = {
    mode: 'open',
    delegatesFocus: true
};
(0, _tslib.__decorate)([
...
},{"tslib":"lRdW5","../../focus/md-focus-ring.js":"gC8eW","../../ripple/ripple.js":"3Zy29","lit":"4antt","lit/decorators.js":"bCPKi","../../internal/aria/delegate.js":"k1Xhg","../../internal/controller/form-submitter.js":"lvRIK","../../internal/events/form-label-activation.js":"jxOTP","../../labs/behaviors/element-internals.js":"1j4WF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gC8eW":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MdFocusRing", ()=>MdFocusRing);
var _tslib = require("tslib");
var _decoratorsJs = require("lit/decorators.js");
var _focusRingJs = require("./internal/focus-ring.js");
var _focusRingStylesJs = require("./internal/focus-ring-styles.js");
let MdFocusRing = class MdFocusRing extends (0, _focusRingJs.FocusRing) {
};
MdFocusRing.styles = [
    (0, _focusRingStylesJs.styles)
];
MdFocusRing = (0, _tslib.__decorate)([
    (0, _decoratorsJs.customElement)('md-focus-ring')
], MdFocusRing);

},{"tslib":"lRdW5","lit/decorators.js":"bCPKi","./internal/focus-ring.js":"4Gt6D","./internal/focus-ring-styles.js":"eKNJr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Gt6D":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
var _lit = require("lit");
var _decoratorsJs = require("lit/decorators.js");
var _attachableControllerJs = require("../../internal/controller/attachable-controller.js");
/**
...
class FocusRing extends (0, _lit.LitElement) {
    constructor(){
        super(...arguments);
        /**
         ...
         */ this.inward = false;
        this.attachableController = new (0, _attachableControllerJs.AttachableController)(this, this.onControlChange.bind(this));
    }
    get htmlFor() {
    ...
    /** @private */ handleEvent(event) {
        if (event[HANDLED_BY_FOCUS_RING]) // This ensures the focus ring does not activate when multiple focus rings
    ...
    update(changed) {
        if (changed.has('visible')) // This logic can be removed once the `:has` selector has been introduced
...
},{"tslib":"lRdW5","lit":"4antt","lit/decorators.js":"bCPKi","../../internal/controller/attachable-controller.js":"j6rAN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j6rAN":[function(require,module,exports,__globalThis) {
/**
 * @license
 ...
 * }
 * ```
 */ parcelHelpers.export(exports, "AttachableController", ()=>AttachableController);
var _lit = require("lit");
/**
...
if (!(0, _lit.isServer)) /**
    ...
    for (const record of records)// When a control's `for` attribute changes, inform its
...
class AttachableController {
    ...
    set htmlFor(htmlFor) {
        if (htmlFor === null) this.host.removeAttribute('for');
        else this.host.setAttribute('for', htmlFor);
    }
    get control() {
        if (this.host.hasAttribute('for')) {
            if (!this.htmlFor || !this.host.isConnected) return null;
            return this.host.getRootNode().querySelector(`#${this.htmlFor}`);
        }
        return this.currentControl || this.host.parentElement;
    }
    set control(control) {
        if (control) this.attach(control);
        else this.detach();
    }
    /**
...
},{"lit":"4antt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eKNJr":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MdRipple", ()=>MdRipple);
var _tslib = require("tslib");
var _decoratorsJs = require("lit/decorators.js");
var _rippleJs = require("./internal/ripple.js");
var _rippleStylesJs = require("./internal/ripple-styles.js");
let MdRipple = class MdRipple extends (0, _rippleJs.Ripple) {
};
MdRipple.styles = [
    (0, _rippleStylesJs.styles)
];
MdRipple = (0, _tslib.__decorate)([
    (0, _decoratorsJs.customElement)('md-ripple')
], MdRipple);

},{"tslib":"lRdW5","lit/decorators.js":"bCPKi","./internal/ripple.js":"2MMCE","./internal/ripple-styles.js":"ak24g","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2MMCE":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
var _attachableControllerJs = require("../../internal/controller/attachable-controller.js");
var _animationJs = require("../../internal/motion/animation.js");
 ...
 */ const FORCED_COLORS = (0, _lit.isServer) ? null : window.matchMedia('(forced-colors: active)');
class Ripple extends (0, _lit.LitElement) {
    constructor(){
        super(...arguments);
        /**
         * Disables the ripple.
    ...
    render() {
        ...
        return (0, _lit.html)`<div class="surface ${(0, _classMapJs.classMap)(classes)}"></div>`;
    }
    update(changedProps) {
     ...
     */ handlePointerleave(event) {
        ...
        if (this.state !== State.INACTIVE) this.endPressAnimation();
    }
    ...
    async handlePointerdown(event) {
        ...
        if (this.checkBoundsAfterContextMenu && !this.inBounds(event)) return;
        this.checkBoundsAfterContextMenu = false;
        ...
        if (this.state !== State.TOUCH_DELAY) return;
    ...
    getTranslationCoordinates(positionEvent) {
        ...
        let startPoint;
        if (positionEvent instanceof PointerEvent) startPoint = this.getNormalizedPointerEventCoords(positionEvent);
        else startPoint = {
            x: width / 2,
            y: height / 2
        };
    ...
    startPressAnimation(positionEvent) {
        ...
        this.growAnimation = this.mdRoot.animate({
            ...
            easing: (0, _animationJs.EASING).STANDARD,
            fill: ANIMATION_FILL
        });
    }
    async endPressAnimation() {
        ...
        else if (animation?.currentTime) pressAnimationPlayState = animation.currentTime.to('ms').value;
        ...
        if (this.growAnimation !== animation) // A new press animation was started. The old animation was canceled and
     ...
     */ shouldReactToEvent(event) {
        ...
        if (this.rippleStartEvent && this.rippleStartEvent.pointerId !== event.pointerId) return false;
        if (event.type === 'pointerenter' || event.type === 'pointerleave') return !this.isTouch(event);
    ...
    /** @private */ async handleEvent(event) {
        if (FORCED_COLORS?.matches) // Skip event logic since the ripple is `display: none`.
        return;
        switch(event.type){
            case 'click':
                this.handleClick();
...
(0, _tslib.__decorate)([
    (0, _decoratorsJs.query)('.surface')
], Ripple.prototype, "mdRoot", void 0);

},{"tslib":"lRdW5","lit":"4antt","lit/decorators.js":"bCPKi","lit/directives/class-map.js":"jiVKL","../../internal/controller/attachable-controller.js":"j6rAN","../../internal/motion/animation.js":"1QcE8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jiVKL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _classMapJs = require("lit-html/directives/class-map.js");
parcelHelpers.exportAll(_classMapJs, exports);

},{"lit-html/directives/class-map.js":"1IFol","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1IFol":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../lit-html.js":"1cmQt","../directive.js":"9lbyV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9lbyV":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1QcE8":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ parcelHelpers.export(exports, "createAnimationSignal", ()=>createAnimationSignal);
/**
 ...
 */ parcelHelpers.export(exports, "createThrottle", ()=>createThrottle);
/**
 * Parses an number in milliseconds from a css time value
 */ parcelHelpers.export(exports, "msFromTimeCSSValue", ()=>msFromTimeCSSValue);
const EASING = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ak24g":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
parcelHelpers.export(exports, "styles", ()=>styles);
var _lit = require("lit");
const styles = (0, _lit.css)`:host{display:flex;margin:auto;pointer-events:none}:host([disabled]){display:none}@media(forced-colors: active){:host{display:none}}:host,.surface{border-radius:inherit;position:absolute;inset:0;overflow:hidden}.surface{-webkit-tap-highlight-color:rgba(0,0,0,0)}.surface::before,.surface::after{content:"";opacity:0;position:absolute}.surface::before{background-color:var(--md-ripple-hover-color, var(--md-sys-color-on-surface, #1d1b20));inset:0;transition:opacity 15ms linear,background-color 15ms linear}.surface::after{background:radial-gradient(closest-side, var(--md-ripple-pressed-color, var(--md-sys-color-on-surface, #1d1b20)) max(100% - 70px, 65%), transparent 100%);transform-origin:center center;transition:opacity 375ms linear}.hovered::before{background-color:var(--md-ripple-hover-color, var(--md-sys-color-on-surface, #1d1b20));opacity:var(--md-ripple-hover-opacity, 0.08)}.pressed::after{opacity:var(--md-ripple-pressed-opacity, 0.12);transition-duration:105ms}
`;

},{"lit":"4antt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k1Xhg":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ parcelHelpers.export(exports, "mixinDelegatesAria", ()=>mixinDelegatesAria);
var _lit = require("lit");
...
function mixinDelegatesAria(base) {
    var _a;
    if (0, _lit.isServer) // Don't shift attributes when running with lit-ssr. The SSR renderer
    ...
    class WithDelegatesAriaElement extends base {
        ...
        attributeChangedCallback(name, oldValue, newValue) {
            if (!(0, _ariaJs.isAriaAttribute)(name)) {
                super.attributeChangedCallback(name, oldValue, newValue);
                return;
            }
            if (this[privateIgnoreAttributeChangesFor].has(name)) return;
            ...
            if (newValue === null) delete this.dataset[dataProperty];
            else this.dataset[dataProperty] = newValue;
            this.requestUpdate(ariaAttributeToDataProperty(name), oldValue);
        }
        getAttribute(name) {
            if ((0, _ariaJs.isAriaAttribute)(name)) return super.getAttribute(ariaAttributeToDataAttribute(name));
 ...
 */ function setupDelegatesAriaProperties(ctor) {
    for (const ariaProperty of (0, _ariaJs.ARIA_PROPERTIES)){
        // The casing between ariaProperty and the dataProperty may be different.
        // ex: aria-haspopup -> ariaHasPopup
        const ariaAttribute = (0, _ariaJs.ariaPropertyToAttribute)(ariaProperty);
        ...
        Object.defineProperty(ctor.prototype, ariaProperty, {
            ...
            set (value) {
                ...
                if (value === null) delete this.dataset[dataProperty];
                else this.dataset[dataProperty] = value;
...
},{"lit":"4antt","./aria.js":"80uZG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"80uZG":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ARIA_PROPERTIES", ()=>ARIA_PROPERTIES);
parcelHelpers.export(exports, "ARIA_ATTRIBUTES", ()=>ARIA_ATTRIBUTES);
/**
 ...
 */ parcelHelpers.export(exports, "isAriaAttribute", ()=>isAriaAttribute);
/**
 ...
 */ parcelHelpers.export(exports, "ariaPropertyToAttribute", ()=>ariaPropertyToAttribute);
...
function ariaPropertyToAttribute(property) {
    return property.replace('aria', 'aria-')// IDREF attributes also include an "Element" or "Elements" suffix
    .replace(/Elements?/g, '').toLowerCase();
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lvRIK":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ parcelHelpers.export(exports, "setupFormSubmitter", ()=>setupFormSubmitter);
var _lit = require("lit");
var _elementInternalsJs = require("../../labs/behaviors/element-internals.js");
function setupFormSubmitter(ctor) {
    ...
    ctor.addInitializer((instance)=>{
        ...
        submitter.addEventListener('click', async (event)=>{
            const { type, [(0, _elementInternalsJs.internals)]: elementInternals } = submitter;
...
},{"lit":"4antt","../../labs/behaviors/element-internals.js":"1j4WF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1j4WF":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ parcelHelpers.export(exports, "mixinElementInternals", ()=>mixinElementInternals);
...
function mixinElementInternals(base) {
    class WithElementInternalsElement extends base {
        get [internals]() {
            ...
            if (!this[privateInternals]) // Cast needed for closure
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jxOTP":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "dispatchActivationClick", ()=>dispatchActivationClick);
/**
 ...
 * }
 *
 */ parcelHelpers.export(exports, "isActivationClick", ()=>isActivationClick);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eljQm":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
parcelHelpers.export(exports, "styles", ()=>styles);
var _lit = require("lit");
const styles = (0, _lit.css)`md-elevation{transition-duration:280ms}:host(:is([disabled],[soft-disabled])) md-elevation{transition:none}md-elevation{--md-elevation-level: var(--_container-elevation);--md-elevation-shadow-color: var(--_container-shadow-color)}:host(:focus-within) md-elevation{--md-elevation-level: var(--_focus-container-elevation)}:host(:hover) md-elevation{--md-elevation-level: var(--_hover-container-elevation)}:host(:active) md-elevation{--md-elevation-level: var(--_pressed-container-elevation)}:host(:is([disabled],[soft-disabled])) md-elevation{--md-elevation-level: var(--_disabled-container-elevation)}
`;

},{"lit":"4antt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ae1j2":[function(require,module,exports,__globalThis) {
/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
//# sourceMappingURL=board.54632f9a.js.map
